...
import { Fields, FieldErrors } from 'pages/SignUp/types';
import './SignUp.css';
...
const SignUp: FC = () => {
  ...
  const handleChange = (_event: ChangeEvent, { name, value }:
    InputOnChangeData): void => setFields((prevState) => ({ ...prevState, [name]: value }));

  const handleBlur = (event: ChangeEvent): void => {
